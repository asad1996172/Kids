...
public class learn_things extends AppCompatActivity {

    // For this example, only two pages
    static final int NUM_ITEMS = 3;
    Context mContext;
    ViewPager mPager;
    learn_things.SlidePagerAdapter mPagerAdapter;


    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_learn_things);
    ...
    /* Instantiate a ViewPager and a PagerAdapter. */
        ...
        mPagerAdapter = new learn_things.SlidePagerAdapter(getSupportFragmentManager());
